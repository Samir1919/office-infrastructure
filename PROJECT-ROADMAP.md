...
- The owner-reported login Enter-key fix is merged and deployed from CRM revision `1a8301bca2b4b57bd40a4847b0f83aaa40c6b341`. CI, deployment health, exact-revision, session TTL, and protected record-count checks passed; owner browser confirmation by signing in with Enter remains the final acceptance check. Rollback remains `e7a9ddbf8e8e3b12ba187906484e813150a3490f`.
...
5. Complete owner browser acceptance for CRM revision `1a8301bca2b4b57bd40a4847b0f83aaa40c6b341` by signing in with Enter. After that focused fix, continue the public-readiness sequence with rate limiting, security headers, staged NPM/TLS validation, and separate owner approvals. Hardware work remains deferred.
