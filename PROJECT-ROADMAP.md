...
- The owner approved the next internal application-hardening canary: a 15–128 Unicode-character password policy for new credentials, local common-password rejection, self/last-admin protection, denied-action auditing, trusted-proxy audit IP correction, generic browser errors, and CSP migration planning. Existing users are not force-reset; HSTS/CSP/public edge changes remain outside this canary.
- CRM pull request #6 passed test/build/security and visual-regression CI, merged as revision `dca592b946e1aad1b297c05d51cab58e7cac97c9`, and is approved as the next `crm01` canary target. Rollback remains `55331b096fa64b7fde8d505cc9dd209935b6b5b7`.
...
5. Continue the public-readiness review of password policy, admin-account protection, audit/incident handling, and CSP migration planning. Staged NPM/TLS validation and any public exposure require separate owner approvals and pending FQDN/DNS/router facts. Hardware work remains deferred.
