...
5. Retain `crm_restore_test` until the owner separately approves cleanup. Continue read-only monitoring; public publication remains separately gated, and hardware work remains deferred until the owner explicitly reopens it.
