...
- The owner-reported login Enter-key fix is merged in CRM revision `1a8301bca2b4b57bd40a4847b0f83aaa40c6b341` and approved as the next `crm01` canary target. Deployment must preserve the current MongoDB session design and use `e7a9ddbf8e8e3b12ba187906484e813150a3490f` as the rollback revision.
...
5. Deploy and validate CRM revision `1a8301bca2b4b57bd40a4847b0f83aaa40c6b341` for the owner-reported login-form Enter-key issue. After that focused fix, continue the public-readiness sequence with rate limiting, security headers, staged NPM/TLS validation, and separate owner approvals. Hardware work remains deferred.
